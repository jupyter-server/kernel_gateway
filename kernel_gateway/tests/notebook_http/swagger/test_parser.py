...
class TestSwaggerAPICellParser:
    ...
    def test_basic_is_api_cell(self):
        ...
        assert parser.is_api_cell("#operationId:foo"), (
            "API cell was not detected with "
    ...
    def test_endpoint_sort_custom_strategy(self):
        ...
        endpoints = parser.endpoints(
            (cell["source"] for cell in source_cells), custom_sort_fun
        )
        print(str(endpoints))
    ...
    def test_get_cell_endpoint_and_verb(self):
        ...
        endpoint, verb = parser.get_cell_endpoint_and_verb(
            "# operationId: post_bar_Quo"
        )
