...
class TestSwaggerBuilders:
    ...
    def test_add_cell_adds_api_cell_to_spec(self):
        ...
        result = builder.build()
        assert (
            result["paths"]["/some/resource"] == expected
    ...
    def test_all_swagger_preserved_in_spec(self):
        ...
        assert json.dumps(
            result["paths"]["/some/resource"], sort_keys=True
        ) == json.dumps(
    ...
    def test_add_undocumented_cell_does_not_add_non_api_cell_to_spec(self):
        ...
        builder = SwaggerSpecBuilder(
            SwaggerCellParser(comment_prefix="#", notebook_cells=[])
        )
