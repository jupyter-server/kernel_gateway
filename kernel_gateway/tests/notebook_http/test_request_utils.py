...
class TestRequestUtils(unittest.TestCase):
    ...
    def test_parse_body_defaults_to_text_plain(self):
        ...
        result = parse_body(request)
        self.assertEqual(
            result, '{"foo" : "bar"}', "Did not properly handle body = empty string."
        )
    ...
    def test_headers_to_dict(self):
        ...
        self.assertEqual(
            result["Content-Type"],
            "application/json",
            "Single value for header was not assigned correctly",
        )
        self.assertEqual(
            result["Set-Cookie"],
            ["A=B", "C=D"],
    ...
    def test_headers_to_dict_with_no_headers(self):
        ...
        self.assertEqual(
            result, {}, "Empty headers handled incorrectly and did not make empty dict"
        )
    ...
    def test_format_request_code_not_escaped(self):
        ...
        self.assertEqual(
            test_request,
            json.loads(test_request_js_value),
    ...
    def test_format_request_with_a_kernel_language_python(self):
        ...
        self.assertTrue(
            request_code.startswith("REQUEST"),
            'Call format_request with a kernel_language "python" was not formatted correctly',
        )
    ...
    def test_format_request_with_a_kernel_language_scala(self):
        ...
        self.assertTrue(
            request_code.startswith("REQUEST"),
            'Call format_request with a kernel_language "scala" was not formatted correctly',
        )
    ...
    def test_format_request_with_a_kernel_language_bash(self):
        ...
        self.assertTrue(
            request_code.startswith('REQUEST="{'),
            'Call format_request with a kernel language "bash" was not formatted correctly',
        )
